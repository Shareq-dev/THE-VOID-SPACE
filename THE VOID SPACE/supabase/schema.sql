...
alter table public.users
  add constraint users_auth_type_check check (auth_type in ('password', 'email', 'guest', 'google'));
...
alter table public.wallpapers
  add constraint wallpapers_auth_type_check check (auth_type in ('password', 'email', 'guest', 'google')),
